...
//            {
//
//                List<Coins> allCoins=new AllData().getCoinObj();
//                Coins obj=null;
    ...
    public void run() {
        ...
        latch.countDown();
            ...
            if(transaction.getType().equals("BUY"))
            {
                ...
                new CoinOperations().buyCoins(obj,transaction.getData().getWalletAddress(),transaction.getData().getCoin(),transaction.getData().getQuantity(),price);
                latch.countDown();
            }
            else if(transaction.getType().equals("SELL"))
            {
                ...
                new CoinOperations().sellCoins(transaction.getData().getWalletAddress(),transaction.getData().getCoin(),transaction.getData().getQuantity(),price);
                latch.countDown();
            }
            else if(transaction.getType().equals("ADD_VOLUME"))
            {
                new CoinOperations().addVolume(transaction.getData().getCoin(),transaction.getData().getVolume());
                latch.countDown();
            }
            else if(transaction.getType().equals("UPDATE_PRICE"))
            {
               new CoinOperations().changePrice(transaction.getData().getCoin(),transaction.getData().getPrice());
                latch.countDown();
            }
