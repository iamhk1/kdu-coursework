...
public class MainTest {
     ...
     */
    @Test
    public void testConcurrentTransactions1() throws InterruptedException {
        JsonNode transactionArray;
        int numberOfThreads = 3;
        CountDownLatch latch = new CountDownLatch(numberOfThreads);
     ...
     */
    @Test
    public void testConcurrentTransactionsMediumFile() throws InterruptedException {
        JsonNode transactionArray;
     ...
     */
    @Test
    public void testConcurrentTransactionsLargeFile() throws InterruptedException {
        JsonNode transactionArray;
    ...
    void testExecuteTransactionImplementsRunnable() {
        ...
        ExecuteTransaction executeTransaction = new ExecuteTransaction(t, latch);
